...
import com.utec.inventario.exception.CampoEquipoNoEditableException;
...
public class UpdateEquipoRequest {
    ...
    // Un campo protegido no se ignora silenciosamente ni se convierte en una edición.
    @JsonAnySetter
    public void rechazarCampoNoEditable(String nombreCampo, Object valor) {
        throw new CampoEquipoNoEditableException();
    }
}
